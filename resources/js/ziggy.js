const Ziggy = {
    ...
    routes: {
        ...
        'demos.store': { uri: 'demos', methods: ['POST'] },
        'assignments.store': { uri: 'assignments', methods: ['POST'] },
        'criteria.store': { uri: 'criteria', methods: ['POST'] },
        'submissions.store': { uri: 'submissions', methods: ['POST'] },
        'criterion-scores.store': { uri: 'criterion-scores', methods: ['POST'] },
        'pipeline-runs.store': { uri: 'pipeline-runs', methods: ['POST'] },
        ...
        demo: { uri: 'demo', methods: ['GET', 'HEAD'] },
    },
};
