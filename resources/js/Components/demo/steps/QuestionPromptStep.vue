<template>
	<div class="bg-white border border-slate-100 rounded-xl p-8 shadow-sm">
		<div class="space-y-6">
			<div>
				<label for="question" class="block text-sm font-semibold text-slate-700 mb-3">Assignment Question</label>
				<div class="relative">
					<textarea 
						id="question" 
						v-model="wizard.question" 
						rows="8" 
				...
				<p class="mt-2 text-xs text-slate-500">Enter the full question or prompt that students will be responding to.</p>
			</div>
		</div>
	</div>
</template>
