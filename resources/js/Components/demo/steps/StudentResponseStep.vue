        ...
        <div class="bg-white border border-slate-100 rounded-xl p-8 shadow-sm">
            <div class="space-y-4">
                <div>
                    ...
                    <p
                        class="text-slate-700 bg-slate-50 p-4 rounded-lg border border-slate-200 whitespace-pre-wrap"
                    >
                        {{ wizard.question }}
                    </p>
                </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="mt-2 text-xs text-slate-500">
                        Enter your complete essay response or written answer to the prompt above.
                    </p>
                </div>
            </div>
        </div>
